              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 "Error: "use cache: private" must not be used within \`unstable_cache()\`.
                     at module.exports (bundler:///app/use-cache-private-in-unstable-cache/page.tsx:21:38)
                     at a (<next-dist-dir>)
                     at b (<next-dist-dir>)
                   19 | }
                   20 |
              ...
              if (isDebugPrerender) {
                expect(output).toMatchInlineSnapshot(`
                 "Error: "use cache: private" must not be used within "use cache". It can only be nested inside of another "use cache: private".
                     at module.exports.__turbopack_context__.s.8005ce08a59abe5fb66e8466491aef18a13fe5374b (bundler:///app/use-cache-private-in-use-cache/page.tsx:15:1)
                     at a (<next-dist-dir>)
                     at b (<next-dist-dir>)
                   13 | }
                   14 |
                ...
                expect(output).toMatchInlineSnapshot(`
                 "Error: "use cache: private" must not be used within "use cache". It can only be nested inside of another "use cache: private".
                     at module.exports.a.s.8005ce08a59abe5fb66e8466491aef18a13fe5374b (bundler:///app/use-cache-private-in-use-cache/page.tsx:15:1)
                     at module.exports (bundler:///app/use-cache-private-in-use-cache/page.tsx:15:16)
                     at a (<next-dist-dir>)
                   13 | }
                   14 |
                 > 15 | async function Private() {
